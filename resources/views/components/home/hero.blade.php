    ...
    <div class="container">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content text-dark dark:text-zinc-200">
                    <h1 class=" font-bold text-4xl sm:text-[42px] lg:text-[40px] xl:text-[42px] leading-snug mb-6">
                        My Name is Simon. <br/>
                        I am <span class="rounded-md text-amber-600">Simael</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        I am a Mechanical Engineering Student. <br/>
                        I love making projects, that's why I created this website for me
                    <a
